...
Блоки четверного типа представляют собой статическую память SRAM, использующуюся как кэш для различных данных.

![Cpu_unit_type4](/imgstore/custom/Cpu_unit_type4.jpg)
